    ...
    <div className="min-h-screen bg-background">
      ...
      <header className="container flex items-center justify-between py-6">
        ...
        <nav className="hidden items-center gap-8 md:flex">
          <a href="#features" className="text-sm font-semibold text-muted-foreground hover:text-foreground">Features</a>
      ...
      <section className="container grid items-center gap-10 py-12 md:grid-cols-2 md:py-20">
        <div className="space-y-6 animate-fade-in">
          <div className="inline-flex items-center gap-2 rounded-full border-2 border-border bg-surface px-4 py-1.5">
            <span className="h-2 w-2 rounded-full bg-secondary" />
            <span className="text-xs font-bold uppercase tracking-wider text-muted-foreground">
              Your AI guide to what's next
            </span>
          </div>
          <h1 className="font-display text-5xl font-black leading-[1.05] text-foreground md:text-7xl">
        ...
        <div className="container">
          ...
          <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-4">
            {features.map((f) => (
              <div
                key={f.title}
                className="rounded-2xl bg-surface p-6 text-foreground transition-transform hover:-translate-y-1"
              >
      ...
      <section id="how" className="container py-20">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {[
            ...
            <div key={s.step} className="rounded-2xl border-2 border-border bg-surface p-6">
